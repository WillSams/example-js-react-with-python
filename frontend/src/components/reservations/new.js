...
const NewReservationComponent = ({ createReservation, handleCloseAlert }) => {
...
export default connectComponent(NewReservationComponent, {
  ...
  dispatch: (dispatch) => ({
    createReservation: (formData) => dispatch({ type: actionTypes.CREATE_RESERVATION, ...formData, }),
